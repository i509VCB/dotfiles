...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    time                    # current time
    battery                 # internal battery - Not shown on machines with no battery
  )
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=$I5_ACCENT_COLOR
  ...
  # This is where buildscripts should be placed in.
  local anchor_files=(
    .bzr
    .citc
    .git
  ...
  typeset -g POWERLEVEL9K_VCS_{CLEAN,UNTRACKED,MODIFIED,LOADING}_FOREGROUND=16
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%237F'  # gray foreground
      local      clean='%237F'  # gray foreground
      local   modified='%237F'  # gray foreground
      local  untracked='%237F'  # gray foreground
      local conflicted='%237F'  # gray foreground
    fi
  ...
  # Transparent background for error symbol
  ...
  typeset -g POWERLEVEL9K_BATTERY_{LOW_THRESHOLD,CHARGING,CHARGED,DISCONNECTED}_BACKGROUND=0
  typeset -g POWERLEVEL9K_BATTERY_LOW_THRESHOLD=20
  typeset -g POWERLEVEL9K_BATTERY_LOW_FOREGROUND=1
  # Show battery in green when it's charging or fully charged.
  typeset -g POWERLEVEL9K_BATTERY_CHARGING_FOREGROUND=11
  typeset -g POWERLEVEL9K_BATTERY_CHARGED_FOREGROUND=40
